...
- 侧边栏手势（#16，PR #37 by @wingsky-1）：屏幕左侧 45% 区域右滑呼出侧边栏；打开后在屏幕任意位置横滑（向左推回或向右拨开都行）即可收起。PR 基础上后加了双向拖动跟手——拉开和收起时侧边栏实时跟着手指走，松手后 0.28s 从手指位置接着滑到终态，快甩小位移也能完成开合，中途切后台或弹出系统模态会自动弹回
