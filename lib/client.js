...
function MobileDrawerFooter({ useSessions, downloadSessionLog, toggleSidebar, t }) {
    ...
    const [tokens, setTokens] = (0, react_1.useState)({ status: 'loading' });
    const refreshTokens = (0, react_1.useCallback)(() => {
        fetch('/api/mobile-nav.tokens.total')
            ...
            .then((body) => {
            setTokens(body.ok && typeof body.totalTokens === 'number'
    ...
    (0, react_1.useEffect)(() => {
        const query = matchMedia(phone_chrome_ts_1.MOBILE_QUERY);
        const sync = () => {
            if (query.matches)
                refreshTokens();
        };
    ...
    const tokensTitle = tokens.status === 'loaded'
        ...
        : t('tokensTotal');
    return ((0, jsx_runtime_1.jsxs)("div", { "data-mobile-nav": "drawer-actions", children: [(0, jsx_runtime_1.jsxs)("button", { type: "button", "data-mobile-nav": "tokens-total", "aria-label": tokensTitle, title: tokensTitle, onClick: refreshTokens, children: [(0, jsx_runtime_1.jsx)(dsh_client_ui_primitives_1.IconSparkle16, { size: 14 }), (0, jsx_runtime_1.jsx)("span", { children: t('tokensTotal') }), (0, jsx_runtime_1.jsx)("span", { children: tokensDisplay })] }), (0, jsx_runtime_1.jsxs)("button", { type: "button", "data-mobile-nav": "explorer", "aria-label": t('files'), title: t('files'), onClick: openExplorer, children: [(0, jsx_runtime_1.jsx)(dsh_client_ui_primitives_1.IconPanelLeftOutline16, { size: 14 }), (0, jsx_runtime_1.jsx)("span", { children: t('files') })] }), (0, jsx_runtime_1.jsxs)("button", { type: "button", "data-mobile-nav": "session-log", "aria-label": t('sessionLog'), title: t('sessionLog'), disabled: sessionId === undefined, onClick: () => {
